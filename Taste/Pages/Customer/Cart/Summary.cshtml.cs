...
namespace Taste.Pages.Customer.Cart
{
    public class SummaryModel : PageModel
    {
        ...
        public IActionResult OnPost(string stripeToken)
        {
            ...
            var pickUpDate = detailCart.OrderHeader.PickUpDate.ToShortDateString();
            var pickUTime = detailCart.OrderHeader.PickUpTime.ToShortTimeString();
            detailCart.OrderHeader.PickUpTime = Convert.ToDateTime(pickUpDate + " " + pickUTime);
